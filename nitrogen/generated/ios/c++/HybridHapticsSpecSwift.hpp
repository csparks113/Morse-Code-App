...
namespace margelo::nitro::morse {
  ...
  public:
    ...
    explicit HybridHapticsSpecSwift(const MorseNitro::HybridHapticsSpec_cxx& swiftPart):
      HybridObject(HybridHapticsSpec::TAG),
      _swiftPart(swiftPart) { }

  public:
    // Get the Swift part
    inline MorseNitro::HybridHapticsSpec_cxx& getSwiftPart() noexcept {
      return _swiftPart;
    }
  ...
  private:
    MorseNitro::HybridHapticsSpec_cxx _swiftPart;
  };
